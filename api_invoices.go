...
@return Invoice
*/
func (a *InvoicesApiService) FindInvoiceByNumber(ctx _context.Context, invoiceId int32) (Invoice, *_nethttp.Response, error) {
	var (
 ...
 * @param "Status" (optional.Interface of Status) -  Only return invoices with this status
@return []Invoice
*/
func (a *InvoicesApiService) GetInvoices(ctx _context.Context, localVarOptionals *GetInvoicesOpts) ([]Invoice, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
