...
@return []HttpForward
*/
func (a *ForwardsApiService) DomainsDomainIdForwardsGet(ctx _context.Context, domainId int32) ([]HttpForward, *_nethttp.Response, error) {
	var (
...
/*
DomainsDomainIdForwardsHostDelete Update forward by host
...
@return HttpForward
*/
func (a *ForwardsApiService) DomainsDomainIdForwardsHostDelete(ctx _context.Context, domainId int32, host string) (HttpForward, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"host"+"}", _neturl.QueryEscape(parameterToString(host, "")) , -1)
...
@return HttpForward
*/
func (a *ForwardsApiService) DomainsDomainIdForwardsHostGet(ctx _context.Context, domainId int32, host string) (HttpForward, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// DomainsDomainIdForwardsHostPutOpts Optional parameters for the method 'DomainsDomainIdForwardsHostPut'
type DomainsDomainIdForwardsHostPutOpts struct {
    HttpForward optional.Interface
}
 ...
 * @param domainId ID of the domain
 * @param host Subdomain of the forward, `@` for the root domain
 * @param optional nil or *DomainsDomainIdForwardsHostPutOpts - Optional Parameters:
 * @param "HttpForward" (optional.Interface of HttpForward) - 
@return HttpForward
*/
func (a *ForwardsApiService) DomainsDomainIdForwardsHostPut(ctx _context.Context, domainId int32, host string, localVarOptionals *DomainsDomainIdForwardsHostPutOpts) (HttpForward, *_nethttp.Response, error) {
	var (
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.HttpForward.IsSet() {
		localVarOptionalHttpForward, localVarOptionalHttpForwardok := localVarOptionals.HttpForward.Value().(HttpForward)
		if !localVarOptionalHttpForwardok {
			return localVarReturnValue, nil, reportError("httpForward should be HttpForward")
		}
		localVarPostBody = &localVarOptionalHttpForward
	}
 ...
 * @param domainId ID of the domain
*/
func (a *ForwardsApiService) DomainsDomainIdForwardsPost(ctx _context.Context, domainId int32) (*_nethttp.Response, error) {
	var (
